  ...
  return (
        ...
        <div className="skill__inner">
            ...
            <div className="skill__desc">
                            ...
                            <p> 
                            JavaScript를 활용한 개발은 실제 사용자 환경에서 발생할 수 있는 다양한 상호작용을 이해하고 이를 기반으로 테스트 케이스를 설계하며 테스트 환경경에서 자주 사용되는 언어라고 생각합니다. <br/><br/> 프로젝트를 진행하면서 코드의 가독성과 유지보수성을 높이는 방법을 고민했고 개발자와의 원활한 소통에도 기여할 수 있다고 생각합니다.
                            </p>
